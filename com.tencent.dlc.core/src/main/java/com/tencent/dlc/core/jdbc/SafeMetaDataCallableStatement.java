...
/**
 * {@link CallableStatement} wrapper that ensures every {@link ResultSet} is
 * wrapped with safe metadata.
 */
class SafeMetaDataCallableStatement extends SafeMetaDataPreparedStatement implements CallableStatement {

    private final CallableStatement delegate;

    SafeMetaDataCallableStatement(CallableStatement delegate, SafeMetaDataConnection connection, String sql) {
        super(delegate, connection, sql);
