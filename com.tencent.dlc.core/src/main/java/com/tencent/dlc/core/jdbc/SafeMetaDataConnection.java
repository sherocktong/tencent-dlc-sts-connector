...
final class SafeMetaDataConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return new SafeMetaDataPreparedStatement(delegate.prepareStatement(DlcQueryRewriter.rewrite(sql)), this, sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return new SafeMetaDataPreparedStatement(delegate.prepareStatement(DlcQueryRewriter.rewrite(sql), resultSetType, resultSetConcurrency), this, sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new SafeMetaDataPreparedStatement(delegate.prepareStatement(DlcQueryRewriter.rewrite(sql), resultSetType, resultSetConcurrency, resultSetHoldability), this, sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new SafeMetaDataPreparedStatement(delegate.prepareStatement(DlcQueryRewriter.rewrite(sql), autoGeneratedKeys), this, sql);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new SafeMetaDataPreparedStatement(delegate.prepareStatement(DlcQueryRewriter.rewrite(sql), columnIndexes), this, sql);
    }

    @Override
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new SafeMetaDataPreparedStatement(delegate.prepareStatement(DlcQueryRewriter.rewrite(sql), columnNames), this, sql);
    }
