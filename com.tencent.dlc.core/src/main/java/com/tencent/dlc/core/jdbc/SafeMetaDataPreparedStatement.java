...
/**
 * {@link PreparedStatement} wrapper that ensures every {@link ResultSet} is
 * wrapped with safe metadata.
 */
class SafeMetaDataPreparedStatement extends SafeMetaDataStatement implements PreparedStatement {
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        ...
        return metaData == null ? new DlcSingleColumnMetaData() : metaData;
    }
    ...
    SafeMetaDataConnection getConnectionWrapper() {
        return connection;
    }
